...
module.exports=[
  ...
  ["I really don't think George RR Martin should have added dragons to the story.", "I understand that this is fantasy, but dragons just push it too far.", "It just makes Daenerys seem overpowered, and like the story will be completely predictable once she gets to Westeros.", "And that all of the events leading up to it would be moot.", "If they want the story to continue, they really need to kill one of them off, preferably Drogon. Something needs to happen to make them seem less invincible.", "And I swear to god if she ends up with Jon Snow..."],
  ["What's a mathematician's favorite appetizer?", "Octonion rings!", "Wow! I didn't expect you to keep talking to me after that. Did you know that rings without a multiplicative identity are called 'rngs'? Like 'ring', but without the i!", "That's about all of the abstract algebra humor I know, so here's a lecture on Boolean algebra", "In Boolean algebra, there are two operators, both binary: OR and AND", "OR is true when one or both of its arguments are true", "and AND is true when both of its arguments are true.", "This means that true OR false is true, but true AND false is false!"],
  ["JavaScript (\"JS\" for short) is a full-fledged dynamic programming language that, when applied to an HTML document, can provide dynamic interactivity on websites. It was invented by Brendan Eich, co-founder of the Mozilla project, the Mozilla Foundation, and the Mozilla Corporation.", "You can do pretty much anything with JavaScript. You'll start small with simple features such as carousels, image galleries, fluctuating layouts, and responses to button clicks. Eventually as you get more experienced with the language, you'll be able to create games, animated 2D and 3D graphics, full blown database-driven apps, and more!", "JavaScript itself is fairly compact but very flexible, and developers have written a lot of tools on top of the core JavaScript language, to unlock a huge amount of extra functionality with very little effort. These include:", "Application Programming Interfaces (APIs) built into web browsers, providing various functionality like dynamically creating HTML and setting CSS styles, grabbing and manipulating a video stream from the user's webcam, or generating 3D graphics and audio samples.", "Third-party APIs to allow developers to incorporate functionality in their sites from other properties, such as Twitter or Facebook.", "Third-party frameworks and libraries you can apply to your HTML to allow you to rapidly build up sites and applications."]
]
...
},{"./bayesian.json":1,"immutable":5,"readline":4}],3:[function(require,module,exports){
...
},{"./bayesian.js":2}],4:[function(require,module,exports){
